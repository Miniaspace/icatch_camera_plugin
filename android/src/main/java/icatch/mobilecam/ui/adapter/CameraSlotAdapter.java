...
public class CameraSlotAdapter extends BaseAdapter {
    ...
    public View getView(int arg0, View convertView, ViewGroup arg2) {
        ...
        if (camSlotItem.isOccupied) {
            ...
            if (camSlotItem.addType == CameraAddType.WIFI_CONNECTION_AUTO) {
                slotCameraName.setTextColor(context.getResources().getColor(R.color.orange));
            } else {
                slotCameraName.setTextColor(context.getResources().getColor(R.color.white));
            }
