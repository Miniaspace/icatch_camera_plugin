...
public class LocalPhotoPbViewPagerAdapter extends PagerAdapter {
    ...
    public LocalPhotoPbViewPagerAdapter(Context context, List<FileItemInfo> filesList) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        FileItemInfo itemInfo = filesList.get(position);
...
//            ImageLoaderUtil.loadImageView(path, photoView);
            ImageLoaderUtil.loadImageView(itemInfo.getThumbPath(), photoView, new ImageLoaderUtil.OnLoadListener() {
                @Override
