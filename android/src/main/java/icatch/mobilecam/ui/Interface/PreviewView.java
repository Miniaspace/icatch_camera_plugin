...
public interface PreviewView {
    ...
    void loadSetting(List<SettingGroup> groupList);

    void refeshSetting();

    void setSettingItemClickListener(CommonItemView.OnItemClickListener listener);

    void setSettingSwitchChangedListener(CommonItemView.OnSwitchChangedListener listener);

    void setAutoDownloadForUri(Uri uri);
}
