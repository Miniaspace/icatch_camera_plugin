...
public class PhotoPbActivity extends MobileCamBaseActivity implements PhotoPbView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_photo_pb);
         ...
         shareBtn = findViewById(R.id.photo_pb_share);
        ...
        panoramaTypeBtn = findViewById(R.id.panorama_type_btn);
...
//    }
    ...
    @Override
    public void setPanoramaTypeBtnImg(int resId) {
    ...
    @Override
    public void setShareBtnVisibility(int visibility) {
