...
import com.icatch.mobilecam.Presenter.RemoteMultiPbPresenter2;
...
public class RemoteMultiPbActivity2 extends MobileCamBaseActivity implements MultiPbView2 {
    private String TAG = "RemoteMultiPbActivity2";
    private ViewPager viewPager;//页卡内容V
    private RemoteMultiPbPresenter2 presenter;
    TabLayout tabLayout;
    MenuItem filterItem;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multi_pb2);
        ...
        presenter = new RemoteMultiPbPresenter2(this);
