...
import com.icatch.mobilecam.Function.streaming.RenderType;
...
public class PreviewActivity extends MobileCamBaseActivity implements View.OnClickListener, PreviewView {
...
//    private ListView mainMenuList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settingLayout = findViewById(R.id.commont_layout);
...
//
        ...
        previewPlayerView.setOnTouchListener(new View.OnTouchListener() {
            @Override
...
//        presenter.destroyPreview();
    ...
    // Deprecated method - commented out for compatibility
    /*
    @Override
...
//        }
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.multi_pb) {
            ...
            if (!ClickUtils.isFastDoubleClick(R.id.multi_pb)) {
                presenter.redirectToAnotherActivity(PreviewActivity.this, RemoteMultiPbActivity2.class);
            }
    ...
    public void setAutoDownloadForUri(Uri uri) {
        GlideUtils.loadImageViewLodingSizeForUri(this, uri, 150, 150, autoDownloadImagview, R.drawable.local_default_thumbnail, R.drawable.local_default_thumbnail);
    }
...
//        mainMenuList.setAdapter(settingListAdapter);
    ...
    public int getSurfaceViewWidth() {
        View parentView = (View)  previewPlayerView.getParent();
    ...
    public void initPreviewPlayerView(MediaStreamPlayer mediaStreamPlayer,boolean enableRender) {
        ...
        previewPlayerView.setRenderType(enableRender? PreviewRenderType.SDK_RENDER : PreviewRenderType.APP_RENDER);
        previewPlayerView.enableZoom(false);
//        previewPlayerView.setRenderType( PreviewRenderType.APP_RENDER);
        previewPlayerView.setStream(mediaStreamPlayer);
    }
    ...
    @Override
    public void loadSetting(List<SettingGroup> groupList) {
        if(settingLayout!= null){
            settingLayout.loadView(groupList);
        }
    }
    ...
    public void refeshSetting() {
        if(settingLayout!= null){
            settingLayout.refresh();
        }
    }

    @Override
    public void setSettingItemClickListener(CommonItemView.OnItemClickListener listener) {
        if(settingLayout!= null){
            settingLayout.setOnItemClickListener(listener);
        }
    }

    @Override
    public void setSettingSwitchChangedListener(CommonItemView.OnSwitchChangedListener listener) {
        if(settingLayout!= null){
            settingLayout.setOnSwitchChangedListener(listener);
        }
    }
}
