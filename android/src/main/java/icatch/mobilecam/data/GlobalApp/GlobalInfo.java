...
public class GlobalInfo {
    ...
    private List<FileItemInfo> localPhotoList;
    private List<FileItemInfo> localVideoList;
    ...
    public List<FileItemInfo> getLocalPhotoList() {
        return localPhotoList;
    }

    public void setLocalPhotoList(List<FileItemInfo> localPhotoList) {
        this.localPhotoList = localPhotoList;
    }

    public void setLocalVideoList(List<FileItemInfo> localVideoList) {
        this.localVideoList = localVideoList;
    }

    public List<FileItemInfo> getLocalVideoList() {
