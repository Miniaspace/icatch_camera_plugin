...
public class AppInfo {
    ...
    public static final String SDK_VERSION = "V3.6.0.53";
    ...
    public static final String DOWNLOAD_CACHE_PATH = "/Download/";
...
//    public static boolean disableLive = false;
    ...
    public static String default_pwd = "1234567890";
    ...
    public static int connectionCheckInterval = 1;
    public static int connectionCheckTimes = 4;
    public static boolean localPbUseSdkRender = false;
