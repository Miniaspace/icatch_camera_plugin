...
public class CameraProperties {
    ...
    public List<String> getSupportedImageSizes() {
        ...
        if (list != null) {
            ...
            AppLog.i(tag, "end getSupportedImageSizes list is null");
            list = new ArrayList<>();
        }
        return list;
    }
    ...
    public List<String> getSupportedVideoSizes() {
        ...
        if(list != null){
            ...
            AppLog.i(tag, "begin getSupportedVideoSizes list is null");
            list = new ArrayList<>();
        }
    ...
    public List<Integer> getSupportedWhiteBalances() {
        ...
        if(list != null){
            ...
            AppLog.i(tag, "end getSupportedWhiteBalances list is null");
            list = new ArrayList<>();
        }
    ...
    public List<Integer> getSupportedCaptureDelays() {
        ...
        if(list != null){
            ...
            AppLog.i(tag, "end getSupportedCaptureDelays lis is null");
        }
    ...
    public List<Integer> getSupportedLightFrequencys() {
        ...
        if(list != null){
            ...
            AppLog.i(tag, "end getSupportedLightFrequencys list is null");
            list = new ArrayList<>();
        }
...
//			retVal = cameraProperty.setLightFrequency(value);
    ...
    public int getCurrentDateStamp() {
        ...
        cacheDateStamp = retValue;
        return retValue;
    }

    public int getCacheDateStamp() {
        if(cacheDateStamp == -1){
            getCurrentDateStamp();
        }
        return cacheDateStamp;
    }
    ...
    public List<Integer> getSupportFuction() {
        ...
        if(fuction == null){
            fuction = new ArrayList<>();
            AppLog.i(tag, "end getSupportFuction fuction is null");
        }
    ...
    public boolean isSDCardExist() throws IchSocketException {
...
//        modeList = getSupportedModes();
    ...
    public List<Integer> getsupportedBurstNums() {
        ...
        if(list != null && !list.isEmpty()){
            ...
            AppLog.i(tag, "end getsupportedBurstNums list is null");
            list = new ArrayList<>();
        }
        return list;
    }
...
//        return list;
    ...
    public List<Integer> getSupportedTimeLapseDurations() {
        ...
        if(list != null){
            ...
            AppLog.i(tag, "end getSupportedTimeLapseDurations list is null");
            list = new ArrayList<>();
        }
    ...
    public List<Integer> getSupportedTimeLapseIntervals() {
        ...
        if(list != null){
            ...
            AppLog.i(tag, "end getSupportedTimeLapseIntervals list is null");
            list = new ArrayList<>();
        }
...
//        K10
    ...
    public List<Integer> getSupportedPropertyValues(int propertyId) {
        ...
        if(list != null){
            ...
            AppLog.i(tag, "end getSupportedPropertyValues is null");
            list = new ArrayList<>();
        }
