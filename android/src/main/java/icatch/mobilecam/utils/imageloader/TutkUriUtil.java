...
public class TutkUriUtil {
    ...
    public static String getTutkThumbnailUri(int fileHandle,String fileName,long size) {

        // int fileType, String fileName, long fileSize
        String fileInfoStr = "fileHandle=" + fileHandle  + "&fileName=" + fileName + "&fileSize=" + size + "&thumbnail";
        return URI_PREFIX + fileInfoStr;
    }
