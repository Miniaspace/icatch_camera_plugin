...
public class GlideUtils {
    ...
    public static void loadImageViewLodingSizeForUri(Context mContext, Uri uri, int width, int height, ImageView mImageView, int lodingImage, int
            errorImageView) {
        Glide.with(mContext).load(uri).override(width, height).placeholder(lodingImage).error(errorImageView).into(mImageView);
    }
