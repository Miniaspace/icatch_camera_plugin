...
public class CameraSlotSQLiteHelper extends SQLiteOpenHelper{
	...
	private String CREATE_CAMINFODB = "CREATE TABLE IF NOT EXISTS cameraSlotInfo (_id integer primary key autoincrement, isOccupied integer, cameraName varchar, cameraType integer, imageBuffer blob, addType integer, wifiPassword varchar)";
