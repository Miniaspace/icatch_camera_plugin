...
public class MyCamera {
    ...
    public MyCamera(int cameraType, String ssid, String ipAddress, int position, int mode, int addType, String wifiPassword) {
    ...
    public MyCamera(int cameraType, UsbDevice usbDevice, int position) {
        ...
        this.addType = CameraAddType.USB_CONNECTION;
        this.wifiPassword = "";
    }
...
//            }
        ...
        if (ret) {
            isConnected = true;
            try {
                cameraAction = new CameraAction(commandSession.getSession().getControlClient(), ICatchCameraSession.getCameraAssist(transport));
    ...
    private boolean initCamera() {
        ...
        ICatchCameraSession iCatchCommandSession = commandSession.getSession();
