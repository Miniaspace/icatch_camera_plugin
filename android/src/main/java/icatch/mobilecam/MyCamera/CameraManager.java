...
//        }
    ...
    public synchronized MyCamera createCamera(int cameraType, String ssid, String ipAddress,int position, int mode, int addType, String wifiPassword) {
        this.curCamera = new MyCamera(cameraType, ssid, ipAddress,position, mode, addType, wifiPassword);
