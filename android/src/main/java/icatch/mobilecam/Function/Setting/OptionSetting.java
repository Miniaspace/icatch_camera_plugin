...
public class OptionSetting {
    ...
    public void showSettingDialog(int nameId, Activity activity) {
        ...
        if (nameId == R.string.setting_image_size) {
            ...
            try {
                isExist = cameraProperties.isSDCardExist();
            } catch (IchSocketException e) {
                e.printStackTrace();
            }
            if (!isExist) {
            ...
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.R){
                fwPth = context.getExternalCacheDir().toString() + AppInfo.PROPERTY_CFG_DIRECTORY_PATH;
            }else {
                fwPth = Environment.getExternalStorageDirectory().toString() + AppInfo.PROPERTY_CFG_DIRECTORY_PATH;
            }
//            = Environment.getExternalStorageDirectory().toString() + AppInfo.PROPERTY_CFG_DIRECTORY_PATH;

            String fwUpgradeName = AppInfo.FW_UPGRADE_FILENAME;
            String fwFileName = fwPth + fwUpgradeName;
            AppLog.d(TAG,"UpdateFw fwFileName:" + fwFileName);
            if (!FileTools.checkFwUpgradeFile(fwPth, fwUpgradeName)) {
                AppLog.d(TAG,"UpdateFW  checkFwUpgradeFile is false");
            ...
            showUpdateFWDialog(context,fwFileName);
    ...
    public void showFastMotionMovieDialog(final Context context) {
        ...
        for (int i = 0; i < length; i++) {
            String str = fastMotionMovieUIString[i];
            if (str == null || str.isEmpty()) {
                AppLog.e(TAG, "item == null");
                return;
            }
    ...
    public void showAutoPowerOffDialog(final Context context) {
        ...
        for (int i = 0; i < length; i++) {
            String str = autoPowerOffUIString[i];
            if (str == null || str.isEmpty()) {
                AppLog.e(TAG, "item == null");
                return;
            }
    ...
    public void showScreenSaverDialog(final Context context) {
        ...
        for (int i = 0; i < length; i++) {
            String str = screenSaverUIString[i];
            if (str == null || str.isEmpty()) {
                AppLog.e(TAG, "item == null");
                return;
            }
...
//                            handler.obtainMessage(AppMessage.OPEN_WIFI_HOTSPOT_FAILED).sendToTarget();
    ...
    private void showUpdateFWDialog(final Context context,final String fwFileName) {
        ...
        builder.setPositiveButton(R.string.setting_yes, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        AppLog.d(TAG,"updateFW " +fwFileName);
                        if (!cameraAction.updateFW(fwFileName)) {
                            handler.post(new Runnable() {
                                @Override
                                public void run() {
                                    MyProgressDialog.closeProgressDialog();
...
//                                    alertDialog.show();
    ...
    private void showSlowMotionDialog(final Context context) {
        ...
        for (int i = 0; i < length; i++) {
            String str = slowmotionUIString[i];
            if (str == null || str.isEmpty()) {
                AppLog.e(TAG, "item == null");
                return;
            }
    ...
    private void showTimeLapseModeDialog(final Context context) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            String str = timeLapseModeString[i];
            if (str == null || str.isEmpty()) {
                AppLog.e(TAG, "item == null");
                return;
            }
            if (timeLapseModeString[i].equals(curValue)) {
                curIdx = i;
            }
        }
    ...
    private void showTimeLapseDurationDialog(final Context context) {
        ...
        for (int i = 0; i < length; i++) {
            String str = videoTimeLapseDurationString[i];
            if (str == null || str.isEmpty()) {
                AppLog.e(TAG, "item == null");
                return;
            }
    ...
    private void showTimeLapseIntervalDialog(final Context context) {
        ...
        for (int i = 0; i < length; i++) {
            String str = videoTimeLapseIntervalString[i];
            if (str == null || str.isEmpty()) {
                AppLog.e(TAG, "item == null");
                return;
            }
    ...
    private void showDelayTimeOptionDialog(final Context context, final OnSettingCompleteListener settingCompleteListener) {
        ...
        for (int i = 0; i < length; i++) {
            String str = delayTimeUIString[i];
            if (str == null || str.isEmpty()) {
                AppLog.e(TAG, "item == null");
                return;
            }
    ...
    public void showImageSizeOptionDialog(final Context context) {
        ...
        for (int ii = 0; ii < length; ii++) {
            String str = imageSizeUIString[ii];
            if (str == null || str.isEmpty()) {
                AppLog.e(TAG, "item == null");
                return;
            }
    ...
    private void showVideoSizeOptionDialog(final Context context) {
        ...
        for (int i = 0; i < length; i++) {
            String str = videoSizeUIString[i];
            if (str == null || str.isEmpty()) {
                AppLog.e(TAG, "item == null");
                return;
            }
    ...
    private void showDateStampOptionDialog(final Context context) {
        ...
        for (int i = 0; i < length; i++) {
            String str = dateStampUIString[i];
            if (str == null || str.isEmpty()) {
                AppLog.e(TAG, "item == null");
                return;
            }
    ...
    private void showWhiteBalanceOptionDialog(final Context context) {
        ...
        int curIdx = 0;
        for (int i = 0; i < length; i++) {
            String str = whiteBalanceUIString[i];
            if (str == null || str.isEmpty()) {
                AppLog.e(TAG, "item == null");
                return;
            }
...
//        wifiListener.registerReceiver();
    ...
    public void showExposureCompensationDialog(final Context context) {
        ...
        for (int i = 0; i < length; i++) {
            String str = exposureCompensationUIString[i];
            if (str == null || str.isEmpty()) {
                AppLog.e(TAG, "item == null");
                return;
            }
    ...
    public void showVideoFileLengthDialog(final Context context) {
        ...
        for (int i = 0; i < length; i++) {
            String str = videoFileLengthUIString[i];
            if (str == null || str.isEmpty()) {
                AppLog.e(TAG, "item == null");
                return;
            }
